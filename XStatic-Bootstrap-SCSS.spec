...
License  : MIT
Requires: XStatic-Bootstrap-SCSS-python = %{version}-%{release}
Requires: XStatic-Bootstrap-SCSS-python3 = %{version}-%{release}
...
cd %{_builddir}/XStatic-Bootstrap-SCSS-3.3.7.1
